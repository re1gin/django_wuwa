...
class IdealBuildSonata(models.Model):
    ...
    def clean(self):
        ...
        ideal_echos_in_build = self.build.ideal_echo.all()
        ...
        for ideal_echo_entry in ideal_echos_in_build:
            if hasattr(ideal_echo_entry.echo, 'sonata') and ideal_echo_entry.echo.sonata == self.sonata:
...
class Build(models.Model):
    ...
    ideal_weapon = models.ManyToManyField(IdealBuildWeapon, related_name='builds_featuring_this_ideal_weapon')
    ideal_echo = models.ManyToManyField(IdealBuildEcho, related_name='builds_featuring_this_ideal_echo')
    ideal_sonata = models.ManyToManyField(IdealBuildSonata, related_name='builds_featuring_this_ideal_sonata')
